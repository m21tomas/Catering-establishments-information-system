...
public class CartService {
	...
	public Page<CartItemsResponseDTO> getAPageOfCartItems(Pageable pageable, String username){
		...
		Page<CartItemsResponseDTO> dtoPage = cartItems.map(cartItem -> {
	        CartItemsResponseDTO dto = new CartItemsResponseDTO(); 

	        dto.setCartItemId(cartItem.getId());
	        dto.setDishId(cartItem.getDish().getId());
	        dto.setDishName(cartItem.getDish().getName());
	        dto.setDishDescription(cartItem.getDish().getDescription());
	        dto.setQuantityInCart(cartItem.getQuantity());
	        dto.setServiceResponse("An item in your cart.");
	        dto.setUsername(cartItem.getUser().getUsername());
