...
import it.akademija.security.CustomPasswordEncoder;
	...
	public ResponseEntity<String> authenticateUser(String username, String email){
		...
		if(user != null) {
			if(!user.getEmail().equals(email)) {
				...
				return new ResponseEntity<String>("Neatpažinta tapatybė. Vartotojo \""+username+"\" elektroninio pašto adresas nėra \""+email+"\"", HttpStatus.NOT_FOUND);
			}
